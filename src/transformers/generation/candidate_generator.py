...
class AssistedCandidateGenerator(CandidateGenerator):
    ...
    def _generate_candidates(self, generation_args: dict) -> tuple[torch.LongTensor, torch.FloatTensor ]:
...
class AssistedCandidateGeneratorDifferentTokenizers(AssistedCandidateGenerator):
    ...
    def __init__(
        ...
        self.prev_target_ids_len: int  = None
...
class AssistantToTargetTranslator:
    ...
    def __init__(
        ...
        self.logits_processors: LogitsProcessorList  = None
...
class UniversalSpeculativeDecodingGenerator(AssistedCandidateGeneratorDifferentTokenizers):
    ...
    def __init__(
        ...
        self._prev_assistant_ids: torch.LongTensor  = None
